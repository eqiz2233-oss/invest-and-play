...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Calendar game board
    "cal.game.today": "Today's Actions",
    "cal.game.todaySub": "Small steps, big results — no pressure!",
    "cal.game.saveToday": "Save",
    "cal.game.investToday": "Invest",
    "cal.game.reviewExpenses": "Review this week's expenses (2 min)",
    "cal.game.allDone": "All done for today! Amazing!",
    "cal.game.thisWeek": "This Week",
    "cal.game.streak": "day streak",
    "cal.game.streakTip": "Streaks reward you — missing a day doesn't punish you 💚",
    "cal.game.monthlyGoal": "Monthly Goal",
    "cal.game.monthlySavingGoal": "Saving target this month",
    "cal.game.ofMonth": "of the month done",
    "cal.game.specialQuest": "Special Quest ⭐",
    "cal.game.trySimulation": "Try it →",
    "cal.game.maybeLater": "Maybe later",

    // Simulation
    "sim.title": "What If?",
    "sim.subtitle": "Play with numbers — nothing changes until you say so",
    "sim.disclaimer": "Sandbox mode — doesn't affect your real plan",
    "sim.extraSave": "Save extra per month",
    "sim.investPct": "Investment portion",
    "sim.currentPlan": "Current Plan",
    "sim.newPlan": "New Plan",
    "sim.perMonth": "mo",
    "sim.totalFund": "Total projected",
    "sim.softNote": "Just a friendly estimate — no pressure!",
    "sim.usePlan": "Use this plan",
    "sim.keepCurrent": "Keep current plan",
    "sim.applied": "Plan updated!",
  ...
  th: {
    ...
    // Calendar game board
    "cal.game.today": "สิ่งที่ทำได้วันนี้",
    "cal.game.todaySub": "ทีละก้าวเล็กๆ ผลลัพธ์ยิ่งใหญ่ — ไม่ต้องกดดัน!",
    "cal.game.saveToday": "ออม",
    "cal.game.investToday": "ลงทุน",
    "cal.game.reviewExpenses": "ทบทวนค่าใช้จ่ายสัปดาห์นี้ (2 นาที)",
    "cal.game.allDone": "ทำครบแล้ววันนี้! เยี่ยมมาก!",
    "cal.game.thisWeek": "สัปดาห์นี้",
    "cal.game.streak": "วันต่อเนื่อง",
    "cal.game.streakTip": "สตรีคให้รางวัล — พลาดวันก็ไม่โดนลงโทษ 💚",
    "cal.game.monthlyGoal": "เป้าหมายเดือนนี้",
    "cal.game.monthlySavingGoal": "เป้าออมเดือนนี้",
    "cal.game.ofMonth": "ของเดือนนี้แล้ว",
    "cal.game.specialQuest": "เควสพิเศษ ⭐",
    "cal.game.trySimulation": "ลองดู →",
    "cal.game.maybeLater": "ไว้ทีหลัง",

    // Simulation
    "sim.title": "ถ้าลองทำแบบนี้ล่ะ?",
    "sim.subtitle": "ลองเล่นกับตัวเลข — ไม่มีอะไรเปลี่ยนจนกว่าคุณจะตกลง",
    "sim.disclaimer": "โหมดทดลอง — ไม่กระทบแผนจริง",
    "sim.extraSave": "ออมเพิ่มต่อเดือน",
    "sim.investPct": "สัดส่วนลงทุน",
    "sim.currentPlan": "แผนปัจจุบัน",
    "sim.newPlan": "แผนใหม่",
    "sim.perMonth": "เดือน",
    "sim.totalFund": "ประมาณการรวม",
    "sim.softNote": "แค่ประมาณการเบาๆ — ไม่ต้องกดดัน!",
    "sim.usePlan": "ใช้แผนนี้",
    "sim.keepCurrent": "เก็บแผนเดิม",
    "sim.applied": "อัปเดตแผนแล้ว!",
